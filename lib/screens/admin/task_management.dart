...
class _TaskManagementScreenState extends State<TaskManagementScreen> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        setDialogState(() {
                          ...
                          // Reset max points based on task type
                          if (value == TaskType.yesNo) {
                            _maxPointsController.text = '1';
                          } else if (_maxPointsController.text == '1' && value != TaskType.yesNo) {
                            _maxPointsController.text = '10';
                          }
                        });
                      }
                  ...
                  const SizedBox(height: 16),
                  if (_selectedTaskType == TaskType.points || _selectedTaskType == TaskType.custom)
                    TextFormField(
                  ...
                  if (_selectedTaskType == TaskType.yesNo)
                    const Padding(
                      ...
                      child: Text(
                        'Yes/No tasks are automatically set to 1 point for "Yes" and 0 for "No"',
  ...
  String _getCategoryName(String? categoryId) {
    ...
    final category = _categories.firstWhere(
      (c) => c.id == categoryId,
      orElse: () => CategoryModel(id: '', name: 'Unknown', description: ''),
    );
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text('Category: ${_getCategoryName(task.categoryId)}'),
                        if (task.type == TaskType.yesNo)
                          const Text('Scoring: Yes = 1 point, No = 0 points')
                        else
